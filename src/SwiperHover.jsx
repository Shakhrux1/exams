      ...
      <div className="tovar">
        <div className="flrx">
          <div className="siwiper">
            <div
              className={activeRang === 0 ? "activeCeti" : "cetiActive"}
              style={{ width: "686px", height: "auto" }}
            >
              <img src={cet} alt="" />
            </div>
            <div
              className={activeRang === 1 ? "activeCeti" : "cetiActive"}
              style={{ width: "686px", height: "auto" }}
            >
              <img src={cet2} alt="" />
            </div>
            <div
              className={activeRang === 2 ? "activeCeti" : "cetiActive"}
              style={{ width: "686px", height: "auto" }}
            >
              <img src={cet3} alt="" />
            </div>
            <div
              className={activeRang === 3 ? "activeCeti" : "cetiActive"}
              style={{ width: "686px", height: "auto" }}
            >
              <img src={cet4} alt="" />
            </div>
            <div
              className={activeRang === 4 ? "activeCeti" : "cetiActive"}
              style={{ width: "686px", height: "auto" }}
            >
              <img src={cet5} alt="" />
            </div>
            <div
              className={activeRang === 5 ? "activeCeti" : "cetiActive"}
              style={{ width: "686px", height: "auto" }}
            >
              <img src={cet6} alt="" />
            </div>
            <div
              className={activeRang === 6 ? "activeCeti" : "cetiActive"}
              style={{ width: "686px", height: "auto" }}
            >
              <img src={cet7} alt="" />
            </div>
          ...
          <div>
            ...
            <div className="grid">
              <div
                style={{ backgroundColor: "#6ECFFF" }}
                onClick={() => clickRang(0)}
                className={activeRang === 0 ? "click" : ""}
              ></div>
              <div
                style={{ backgroundColor: "#0000FF" }}
                onClick={() => clickRang(1)}
                className={activeRang === 1 ? "click" : ""}
              ></div>
              <div
                style={{ backgroundColor: "#000" }}
                onClick={() => clickRang(2)}
                className={activeRang === 2 ? "click" : ""}
              ></div>
              <div
                style={{ backgroundColor: "#fff" }}
                onClick={() => clickRang(3)}
                className={activeRang === 3 ? "click" : ""}
              ></div>
              <div
                style={{ backgroundColor: "#CEB593" }}
                onClick={() => clickRang(4)}
                className={activeRang === 4 ? "click" : ""}
              ></div>
              <div
                style={{ backgroundColor: "#008000" }}
                onClick={() => clickRang(5)}
                className={activeRang === 5 ? "click" : ""}
              ></div>
              <div
                style={{ backgroundColor: "#FF0000" }}
                onClick={() => clickRang(6)}
                className={activeRang === 6 ? "click" : ""}
              ></div>
            </div>
          </div>
        </div>
          ...
          <div style={{ display: "flex", cursor: "pointer" }}>
            <div
              ...
              style={{
                ...
                borderBottom:
                  activeTab === "details" ? "2px solid blue" : "none",
              }}
            >
              Детали
            </div>
            ...
            <div
              ...
              style={{
                ...
                borderBottom:
                  activeTab === "payment" ? "2px solid blue" : "none",
              }}
            >
              Оплата
            </div>
          ...
          {activeTab === "delivery" && (
            <div style={{ marginTop: "20px" }}>
              <div className="deliver">
                <h2>Доставка</h2>
                <p>
                  Команда XWEAR предоставляет услугу доставки только
                  оригинальных товаров c крупнейшего китайского маркетплейса
                  Poizon, чтобы наши клиенты экономили более 40% на каждой
                  покупке. Мы ценим вас, поэтому постоянно работаем над
                  логистикой, чтобы ускорить время доставки заказов! Все заказы
                  отправляются из-за границы с возможностью доставки в любой
                  город России, перед отправкой товар всегда проходит проверку
                  на подлиность. Доставляем вещи из-за границы за 12-16 дней до
                  России, включая день оплаты, с возможностью самовывоза из
                  города Екатеринбург. В другие города отправляем СДЭКом. СДЭК
                  оплачивается при получении. Цена доставки зависит от города
                  вашего проживания, в среднем это 350 ₽.
                </p>
                ...
                <div className="grids">
                  ...
                  <div>
                    ...
                    <p>
                      Заказ выкуплен и уже направляется на наш склад в Китае.
                    </p>
                  </div>
                  <div>
                    <img src={ptichka} alt="" />
                    ...
                    <p>
                      Заказ поступил на наш склад в Китае и скоро будет
                      отправлен в Россию.
                    </p>
                  </div>
                  <div>
            ...
            <div style={{ marginTop: "20px" }}>
              <div className="paymet">
                ...
                <p>
                  ...
                  товара на Poizon, доставка его на наш склад в Китае, доставка
                  из Китая до склада в городе Екатеринбург, все таможенные сборы
                  и пошлины уже включены в стоимость.
                </p>
                <p>
                  Если вам нужно отправить товар по России, вы сможете выбрать
                  адрес доставки во время оформления заказа. Доставка
                  оплачивается отдельно при получении посылки, обычно это не
                  более 350 рублей.{" "}
                </p>
              </div>
            </div>
              ...
              <div className="faq">
                ...
                <div>
                  ...
                  <p className={active === 0 ? "active" : ""}>
                    Мы гарантируем полную безопасность ваших персональных
                    данных. Если у вас есть вопросы, пожалуйста, ознакомьтесь с
